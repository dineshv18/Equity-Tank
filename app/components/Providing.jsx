...
const Services = [
  ...
  },
  {
    ...
    des: "We believe in Advance price action , and we'll teach you that how it can be treated in every market situation.",
  },
  {
    id: 3,
    title: "Trading System Guidance",
    icon: <GrSystem fontSize={25} />,
    des: "Our Team will Guide you best for your trading system , so that you can beat any market condition.",
  },
  {
    id: 4,
    title: "Revision Classes ",
    icon: <BiRevision fontSize={25} />,
    des: "Equity Tank will also provide you revision classes of any class which you want to learn revise.",
  },
  {
    id: 5,
    title: "Convert Yourself Into A Pro",
    icon: <FaChartLine fontSize={25} />,
    des: " Our Concepts and Live Guidance will convert you into a professional trader, you will see a massive change into your trading.",
  },
  {
    id: 6,
    title: "Equity Tank ISO Certification",
    icon: <FaAward fontSize={25} />,
    des: "After completion of your course, A test will be given to you. and also we will provide a ISO Certificate of your course by Equity Tank",
  },
];
